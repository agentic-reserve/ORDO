 ...
 * Ordo SQLite Schema
 * 
 * All tables for agent persistent state.
...
export const CREATE_TABLES = `
  ...
  CREATE INDEX IF NOT EXISTS idx_inference_costs_agent ON inference_costs(agent_id);
  CREATE INDEX IF NOT EXISTS idx_inference_costs_model ON inference_costs(model);
  CREATE INDEX IF NOT EXISTS idx_inference_costs_timestamp ON inference_costs(created_at);
